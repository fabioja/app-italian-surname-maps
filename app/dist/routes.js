...
const get_track_controller_1 = __importDefault(require("./controllers/get-track.controller"));
...
routes.get("/tracks", api_Key_validator_1.apiKeyValidator, new get_track_controller_1.default().handle);
